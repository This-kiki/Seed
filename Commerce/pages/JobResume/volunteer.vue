	...
	<view class="infoContainer">
		...
		<view class="list">
			<view class="common">
				...
				<input type="text" v-model="info.volunteerName" placeholder="请填写项目名称" />
			</view>
			<view class="common">
				<text class="name">服务时长</text>
				<input type="text" v-model="info.volunteerLong" placeholder="请填写服务时长" />
			</view>
			<view class="common">
				<text class="name">服务时间</text>
				<input type="text" v-model="info.volunteerTime" placeholder="请填写服务时间" />
			</view>
			<view class="common">
				<text class="name">项目描述</text>
				<textarea v-model="info.volunteerDesc" placeholder="请填写项目描述" />
			</view>
		</view>
