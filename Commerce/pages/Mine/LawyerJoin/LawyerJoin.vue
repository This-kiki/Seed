		...
		<view class="ui-all">
			<view class="avatar" @tap="avatarChoose">
				<view class="imgAvatar">
					<image class="page-headimg" :src="layerMsg.img" mode="aspectFill"></image>
				</view>
			...
			<view class="picker-box">
				<text>律师身份</text>
				<picker class="picker" mode="selector" range-key="label" v-model="layerMsg.subLevel"
			...
			<view class="picker-box">
				<text>性别</text>
				<picker class="picker" mode="selector" range-key="name" v-model="layerMsg.sex" @change="bindSexChange"
					:range="sexlist">
			...
			<view class="picker-box">
				<text>政治面貌</text>
				<picker class="picker" mode="selector" range-key="label" v-model="layerMsg.polity"
