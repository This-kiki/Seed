	...
	<view>
		<loading ref="loadRefresh" :currentPage="currentPage" :totalPages="totalPages" @loadMore="loadMore" @refresh="refresh">
			<view slot="content-list">
				<!-- 数据列表 -->
				<view v-for="(item, index) in list" :key="index"><activity-card :options="item"></activity-card></view>
			</view>
		</loading>
	</view>
</template>
...
import activityCard from '@/components/info_Com/activity-card/index.vue'
export default {
	components: {
		loading,
		activityCard
